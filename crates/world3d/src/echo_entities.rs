            ...
            mesh: Mesh {
                ...
                materials: vec![
                    Material {
                        ...
                        properties: hashmap! {
                            "emission_color".to_string() => vec![0.8, 0.9, 1.0, 1.0],
                            "emission_strength".to_string() => vec![2.0],
                        },
                    },
                ],
            },
            ...
            mesh: Mesh {
                ...
                materials: vec![
                    Material {
                        ...
                        properties: hashmap! {
                            "base_color".to_string() => vec![0.2, 0.5, 0.9, 0.8],
                            "scan_lines".to_string() => vec![1.0],
                            "glitch_amount".to_string() => vec![0.05],
                        },
                    },
                ],
            },
            ...
            mesh: Mesh {
                ...
                materials: vec![
                    Material {
                        ...
                        properties: hashmap! {
                            "base_texture".to_string() => vec![1.0],
                            "moss_coverage".to_string() => vec![0.3],
                            "wind_sway".to_string() => vec![0.1],
                        },
                    },
                    Material {
                        ...
                        properties: hashmap! {
                            "leaf_color".to_string() => vec![0.3, 0.7, 0.2, 1.0],
                            "subsurface".to_string() => vec![0.4],
                        },
                    },
                ],
            },
            ...
            mesh: Mesh {
                ...
                materials: vec![
                    Material {
                        ...
                        properties: hashmap! {
                            "base_color".to_string() => vec![0.8, 0.3, 0.1, 1.0],
                            "metallic".to_string() => vec![0.8],
                            "heat_glow".to_string() => vec![2.0],
                        },
                    },
                    Material {
                        ...
                        properties: hashmap! {
                            "flame_color1".to_string() => vec![1.0, 0.6, 0.1, 1.0],
                            "flame_color2".to_string() => vec![1.0, 0.2, 0.0, 0.8],
                            "turbulence".to_string() => vec![0.5],
                        },
                    },
                ],
            },
